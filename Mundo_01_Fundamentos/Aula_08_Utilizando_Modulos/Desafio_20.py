...
nome_01 = str(input('Digite o primeiro nome: '))
nome_02 = str(input('Digite o segundo nome: '))
nome_03 = str(input('Digite o terceiro nome: '))
nome_04 = str(input('Digite o quarto nome: '))
